...
export const smart_env_config = {
  ...
  items: {
    smart_template: { class: SmartTemplate, version: "2.4.3" }
  },
  modules: {
  ...
  actions: {
    context_suggest_templates: { action: context_suggest_templates_action, display_name: context_suggest_templates_action_display_name, version: "2.4.3" },
    template_build_prompt: { action: template_build_prompt_action, version: "2.4.3" },
    template_copy_with_context: { action: template_copy_with_context_action, version: "2.4.3" }
  }
};
